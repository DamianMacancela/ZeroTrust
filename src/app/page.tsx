          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><a href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '593999999999'}?text=Hola,%20tengo%20una%20audiencia%20y%20me%20interesa%20el%20Programa%20de%20Afiliados%20(Comisiones).`} className="text-xs font-bold text-blue-600 hover:text-blue-800 transition-colors">Programa de Afiliados (Gana 30%)</a></li>
              </ul>
            </div>
